...
The package also exports the formatters the CLI uses for banners and summaries.
Number formatting is delegated to [`@arshad-shah/clif`](https://www.npmjs.com/package/@arshad-shah/clif) (`formatDuration` / `formatBytes`); `formatPath` is ExtForge's cwd-relative path helper:
