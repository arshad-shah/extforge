...
- **Unit tests + build** on Node 20, 22, and 24.
...
See [`SECURITY.md`](https://github.com/arshad-shah/extforge/blob/main/SECURITY.md). **Do not** open a public GitHub issue. Use GitHub private vulnerability reporting at <https://github.com/arshad-shah/extforge/security/advisories/new>, or email shaharshad57@gmail.com.
